...
<body>
    ...
    <section class="sub-header">
        ...
        <h1>Best accessories</h1>
    </section>

    <!------Menu Page-------->
    <section class="menu-content">
        <div class="card">
            <h1 style="font-weight: 200;">Best accessories</h1>
            <span class="garis"></span>
            <h5 style="font-weight: 200; font-size: 18px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Non
                exercitationem sequi distinctio facilis, corrupti ipsa dignissimos fuga dolore, nobis corporis
                repudiandae, placeat molestiae tempore in nemo possimus nihil nulla mollitia.</h5>
        </div>
        <div class="row-espresso">

            @foreach ($produk as $data)
                <div class="menu-espresso">
                    <img src="{{ url('public/app/produk') }}\{{ $data->foto }}" class="img-fluid mb-3"
                        alt="" />
